...
function grabToOut()
  ...
  if Knext.idx == 1 then
    _x = x 
    _y = y + diff
  elseif Knext.idx == 2 then
    _x = x + diff
    _y = y + diff
  elseif Knext.idx == 3 then
    _x = x + diff 
    _y = y + diff
  elseif Knext.idx == 4 then
    _x = x - diff 
    _y = y + diff
  elseif Knext.idx == 5 then
    _x = x 
    _y = y + diff
  elseif Knext.idx == 6 then
    _x = x + diff
    _y = y
  elseif Knext.idx == 7 then
    _x = x - diff
    _y = y
  elseif Knext.idx == 8 then
    _x = x 
    _y = y
  elseif Knext.idx == 9 then
    _x = x + diff
    _y = y - diff
  elseif Knext.idx == 10 then
    _x = x - diff
    _y = y - diff
  elseif Knext.idx == 11 then
    _x = x - diff
    _y = y - diff
  elseif Knext.idx == 12 then
    _x = x 
    _y = y - diff
  end
  ...
  Knext.robax.rax_3 = grabHeight - 40
  MoveAbsJ(Knext,v_grab,fine,tool0,wobj0,load0)  
